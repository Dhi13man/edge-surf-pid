# Contributing to edge-surf-pid

Thanks for improving edge-surf-pid. Open an issue first for large changes so we can
agree on scope.
...
3. Install the toolchain this repo already uses (Python 3) and any dependencies
